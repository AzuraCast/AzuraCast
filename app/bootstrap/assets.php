...
return [
    ...
    [
        ...
        'files' => [
            'js' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/vue/2.5.13/' . (APP_IN_PRODUCTION ? 'vue.min.js' : 'vue.js'),
    ...
    [
        ...
        'files' => [
            'css' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/animate.css/3.5.2/animate.min.css',
                    'sri' => 'sha256-j+P6EZJVrbXgwSR5Mx+eCS6FvP9Wq27MBRC/ogVriY0=',
                ],
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/material-design-iconic-font/2.2.0/css/material-design-iconic-font.min.css',
    ...
    [
        ...
        'files' => [
            'js' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/node-waves/0.7.5/waves.min.js',
    ...
    [
        ...
        'files' => [
            'css' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.min.css',
                    'sri' => 'sha256-zuyRv+YsWwh1XR5tsrZ7VCfGqUmmPmqBjIvJgQWoSDo=',
                ],
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.min.css',
    ...
    [
        ...
        'files' => [
            'js' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.concat.min.js',
                    'sri' => 'sha256-/YAntTqXy9V4LoXFkI5WPDl3ZwP/knn1BljmMJJ7QWc=',
                ],
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.min.js',
                    'sri' => 'sha256-JirYRqbf+qzfqVtEE4GETyHlAbiCpC005yBTa4rj6xg=',
                ],
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/autosize.js/4.0.0/autosize.min.js',
    ...
    [
        ...
        'files' => [
            'js' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/highcharts/6.0.4/highcharts.js',
                    'sri' => 'sha256-jLlwSowwSPJ9ukSEWxfqld2rgZTzBcTJhfotyvtdOSk=',
                ],
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/highcharts/6.0.4/highcharts-more.js',
                    'sri' => 'sha256-QnoLQZe7BYRVTl3AY8Lsw6mn60HfHZNpcZBEndybfBk=',
                ],
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/highcharts/6.0.4/js/modules/exporting.js',
    ...
    [
        ...
        'files' => [
            'js' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/zxcvbn/4.4.2/zxcvbn.js',
    ...
    [
        ...
        'files' => [
            'js' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/chosen/1.8.2/chosen.jquery.min.js',
                    'sri' => 'sha256-j9yXOqKOlGKkAerTz/6KCllekmWP3Kt3a7sBvMK8IGI=',
                ],
            ],
            'css' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/chosen/1.8.2/chosen.min.css',
    ...
    [
        ...
        'files' => [
            'js' => [
                ...
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/2.1.27/daterangepicker.min.js',
                    'sri' => 'sha256-fuPJ7xvV6OPcIGSJd2Xj7s/+2aWsVGapv+Uj/cuVOzk=',
                ],
            ],
            'css' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/2.1.27/daterangepicker.min.css',
    ...
    [
        ...
        'files' => [
            'js' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/codemirror.min.js',
                    'sri' => 'sha256-ag7KgA1S7cuuU2FCC2G7/L8IpaijDSPqzcLLLeJv5Iw=',
                ],
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/mode/css/css.min.js',
                    'sri' => 'sha256-EPuuMaFXpkGuc1TQeBblqQDxuPiTFgd8K+l/vGIC5EQ=',
                ],
            ],
            'css' => [
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/codemirror.min.css',
                    'sri' => 'sha256-I8NyGs4wjbMuBSUE40o55W6k6P7tu/7G28/JGUUYCIs=',
                ],
                [
                    'src' => '//cdnjs.cloudflare.com/ajax/libs/codemirror/5.33.0/theme/material.min.css',
