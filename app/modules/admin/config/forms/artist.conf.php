            ...
            'elements' => array(
                'intro_text' => array('markup', array('markup' => '
                    ...
                    <ul>
                        ...
                        <li>Contact a member of our team on Skype or elsewhere. You can find all of our essential contact information from our <a href="'.\DF\Url::route(array('module' => 'frontend', 'controller' => 'contact')).'" target="_blank">Contact Us page</a>.</li>
                    </ul>
