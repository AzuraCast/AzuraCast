        ...
        'about' => array(
            ...
            'elements' => array(
                ...
                'about_text' => array('markup', array(
                    'markup' => '
                        <p>We are honored that your station is interested in joining the Ponyville Live family. For over a year, the Ponyville Live (or, as we call it, PVL) network of stations has delivered hundreds of hours of live programming, 24/7 radio selections, special video streams, convention coverage, and more to bronies across the world.</p>
                        ...
                        <p>In order for us to add your station to our web site, pop-up player, plugins, and other areas, we need some information about your station. This information also helps our existing station administrators determine if your station is a good fit for the network.</p>

                        <p><b>All new stations joining PVL must be approved by a majority of the existing station leaders.</b> This process may take a week or two after you have submitted your station. If you don\'t get voted in the first time, though, don\'t worry; our team will let you know any feedback they have, and you can always request that the team re-vote on your station after you have made any changes.</p>
        ...
        'basic_info' => array(
            ...
            'elements' => array(
                ...
                'category' => array('radio', array(
                    ...
                    'description' => 'Our stations are categorized by type, so this information helps us choose the appropriate player to use with your station. If you have both a video stream and radio station, please submit both of them separately (as they will use different playback systems).',
                )),
