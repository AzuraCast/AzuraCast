                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <form-group-checkbox
                                ...
                                :label="$gettext('Hide SoundMesh Branding on Public Pages')"
                                :description="$gettext('If selected, this will remove the SoundMesh branding from public-facing pages.')"
                            />
                        </div>
                        ...
                        <form-group-field
                            ...
                            :description="$gettext('If a visitor is not signed in and visits the SoundMesh homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.')"
                        />
