        ...
        <form-fieldset>
            <div class="row g-3">
                ...
                <form-group-field
                    ...
                    :label="$gettext('SoundMesh Instance Name')"
                    :description="$gettext('This name will appear as a sub-header next to the SoundMesh logo, to help identify this server.')"
                />
