            ...
            <form-fieldset>
                ...
                <div class="row g-3">
                    ...
                    >
                        <template #description>
                            {{
                                $gettext('This mode disables SoundMesh\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.')
                            }}
                        </template>
                    </form-group-checkbox>
