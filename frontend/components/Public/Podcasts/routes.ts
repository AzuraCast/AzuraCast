    ...
    return [
        {
            path: "/podcasts",
            component: () =>
                import("~/components/Public/Podcasts/PodcastList.vue"),
            name: "public:podcasts",
        },
        {
            path: "/podcast/:podcast_id",
            component: () =>
                import("~/components/Public/Podcasts/PodcastWrapper.vue"),
            name: "public:podcast",
        },
        {
            ...
            component: () =>
                import(
                    "~/components/Public/Podcasts/PodcastEpisodeWrapper.vue"
                ),
