...
export type PodcastRequired = Required<
    Omit<ApiPodcast, "branding_config" | "categories"> & {
...
export type PodcastResponseBody = Omit<
    PodcastRecord & PodcastExtraData,
    "categories"
> & {
    categories: Required<ApiPodcastCategory>[];
};

export type PodcastEpisodeRecord = Required<
    Omit<
        ApiPodcastEpisode,
        | "id"
        | "links"
...
export type PodcastEpisodeResponseBody = PodcastEpisodeRecord &
    PodcastEpisodeExtraData;
