...
export type WebhookTriggerDetails = {
    [key in WebhookTriggers]: WebhookTriggerDetail;
};
...
export type WebhookTypeDetails = {
    [key in ActiveWebhookTypes]: WebhookTypeDetail;
};
...
export function useTypeDetails(): WebhookTypeDetails {
    ...
    return {
        ...
        [WebhookTypes.TuneIn]: {
            ...
            description: $gettext("Send song metadata changes to %{service}.", {
                service: "TuneIn",
            }),
        },
        ...
        [WebhookTypes.GroupMe]: {
            ...
            description: $gettext(
                "Use the GroupMe Bot API to send a message to a channel.",
            ),
        },
        [WebhookTypes.Mastodon]: {
            title: $gettext("Mastodon Post"),
            description: $gettext(
                "Automatically publish to a Mastodon instance.",
            ),
        },
