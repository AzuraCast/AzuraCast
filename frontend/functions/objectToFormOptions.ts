...
import { ComputedRef, computed, MaybeRefOrGetter, toValue } from "vue";
import {
    ApiFormNestedOptions,
    ApiFormSimpleOptions,
} from "~/entities/ApiInterfaces.ts";

type SimpleFormOptionObject = Record<string | number, string>;

export type SimpleFormOptionInput =
    | ApiFormSimpleOptions
    | SimpleFormOptionObject;
...
type NestedFormOptionObject =
    | SimpleFormOptionObject
    | Record<string | number, SimpleFormOptionObject>;

export type NestedFormOptionInput =
    | ApiFormNestedOptions
    | NestedFormOptionObject;
