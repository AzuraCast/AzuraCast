...
export default function useWebAuthn() {
    ...
    const processRegisterResponse = (
        cred: PublicKeyCredential,
    ): ProcessedRegisterResponse => {
    ...
    const doRegister = async (
        rawArgs: object,
    ): Promise<ProcessedRegisterResponse> => {
        ...
        const rawResp = (await navigator.credentials.create(
            options,
    ...
    const doValidate = async (
    ...
    ): Promise<ProcessedValidateResponse> => {
        ...
        const rawResp = (await navigator.credentials.get(
            options,
        )) as PublicKeyCredential;
