import { Directive, InjectionKey, inject, provide, ShallowRef } from "vue";
...
const provideKey: InjectionKey<LightboxTemplateRefFull> =
    Symbol() as InjectionKey<LightboxTemplateRefFull>;
...
export function useLightbox() {
    ...
    const vLightbox: Directive<HTMLElement, string> = (
        el: HTMLElement,
    ): void => {
