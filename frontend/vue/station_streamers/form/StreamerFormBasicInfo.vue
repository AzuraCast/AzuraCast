        ...
        <b-form-group>
            ...
            <b-row class="mt-3">
                ...
                <b-form-group class="col-md-6" label-for="form_edit_enforce_schedule">
                    <template v-slot:description>
                        <translate>If enabled, this streamer will only be able to connect during their scheduled broadcast times.</translate>
                    </template>
                    <b-form-checkbox id="form_edit_enforce_schedule" v-model="form.enforce_schedule.$model">
                        <translate>Enforce Schedule Times</translate>
                    </b-form-checkbox>
                </b-form-group>
            </b-row>
        </b-form-group>
