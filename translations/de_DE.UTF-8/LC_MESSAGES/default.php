<?php return array (
  ...
  array (
    ...
    array (
      '# Episodes' => '# Episoden',
      '# Songs' => '# Titel',
      '%{ dj } is now live on %{ station }! Tune in now: %{ url }' => '%{ dj } ist jetzt live auf %{ station }! Schalten Sie jetzt ein: %{ url }',
      '%{ hours } hours' => '%{ hours } Stunden',
      '%{ minutes } minutes' => '%{ minutes } Minuten',
      '%{ seconds } seconds' => '%{ seconds } Sekunden',
      '%{ station } is back online! Tune in now: %{ url }' => '%{ station } ist wieder online! Schalten Sie jetzt ein: %{ url }',
      '%{ station } is going offline for now.' => '%{ station } ist vorerst offline.',
      '%{filesCount} File' => 
      array (
        0 => '%{filesCount} Datei',
      ...
      array (
        0 => '%{numPlaylists} Playliste',
        1 => '%{numPlaylists} Wiedergabelisten',
      ),
      '%{numSongs} uploaded song' => 
      array (
        0 => '%{numSongs} hochgeladener Song',
      ...
      'Set to "Yes" to always use "https://" secure URLs, and to automatically redirect to the secure URL when an insecure URL is visited (HSTS).' => 'Auf "Ja" setzen, um immer sichere "https://" URLs zu verwenden und automatisch auf die sichere URL umzuleiten, wenn eine unsichere URL besucht wird (HSTS).',
