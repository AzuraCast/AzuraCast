<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Always Write Playlists to Liquidsoap' => 'Εγγραφή Πάντα των Λιστών Αναπαραγωγής στο Liquidsoap',
      ...
      'AutoCue analyzes your music and automatically calculates cue points, fade points, and volume levels for a consistent listening experience.' => 'Το AutoCue αναλύει τη μουσική σας και υπολογίζει αυτόματα τα σημεία διάσωσης, τα σημεία εξασθένισης και τα επίπεδα του ήχου για μια συνεπή εμπειρία ακρόασης.',
      'AutoDJ' => 'AutoDJ',
      ...
      'Automatically create new podcast episodes when media is added to a specified playlist.' => 'Αυτόματη δημιουργία νέων επεισοδίων podcast όταν τα μέσα προστίθενται σε μια καθορισμένη λίστα αναπαραγωγής.',
      ...
      'Calculate and use normalized volume level metadata for each track.' => 'Υπολογισμός και χρήση κανονικοποιημένο επίπεδο έντασης για κάθε κομμάτι.',
      'Cancel' => 'Ακύρωση',
      ...
      'Enable certain advanced features in the web interface, including advanced playlist configuration, station port assignment, changing base media directories and other functionality that should only be used by users who are comfortable with advanced functionality.' => 'Ενεργοποιήστε ορισμένες προηγμένες λειτουργίες στη διεπαφή ιστού, συμπεριλαμβανομένης της προηγμένης διαμόρφωσης της λίστας αναπαραγωγής, τον καθορισμό των πορτών του σταθμού, αλλάζοντας τους βασικούς καταλόγους μέσων και άλλες λειτουργίες που θα πρέπει να χρησιμοποιούνται μόνο από χρήστες που είναι άνετοι με την προηγμένη λειτουργικότητα.',
      ...
      'LiquidSoap is currently shuffling from %{songs} and %{playlists}.' => 'Το Liquidsoap αυτή τη στιγμή αναπαράγει σε τυχαία σειρά από %{songs} και %{playlists}.',
      ...
      'RadioRed Organization API Key' => 'Κλειδί API του Οργανισμού RadioRed',
      ...
      'Remove' => 'Αφαίρεση',
      'Remove any extra metadata (fade points, cue points, etc.) from the selected media' => 'Αφαιρέση τυχόν επιπλέον μεταδεδομένων (σημεία εξασθένισης, σημεία cue, κλπ.) από τα επιλεγμένα μέσα',
      ...
      'This station does not currently support on-demand media.' => 'Αυτός ο σταθμός δεν υποστηρίζει επί του παρόντος μέσα επί παραγγελίας.',
