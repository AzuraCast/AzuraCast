<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Copied!' => '복사되었습니다!',
      'Copies older than the specified number of days will automatically be deleted. Set to zero to disable automatic deletion.' => '지정된 일수보다 오래된 사본은 자동으로 삭제됩니다. 자동 삭제를 비활성화하려면 0으로 설정하세요.',
      ...
      'Error queueing files:' => '파일을 대기열에 넣는 과정에서 오류:',
      'Error removing files:' => '파일 제거 중 오류:',
      'Error reprocessing files:' => '파일 재처리 중 오류:',
      'Error updating playlists:' => '재생 목록 업데이트 중 오류:',
      ...
      'Instruct Liquidsoap to use any replaygain metadata associated with a song to control its volume level. This may increase CPU consumption.' => 'Liquidsoap에 노래와 관련된 재생 이득 메타데이터를 사용하여 볼륨 레벨을 제어하도록 지시합니다. 이로 인해 CPU 소비가 증가할 수 있습니다.',
      'Instructions' => '지침',
      ...
      'Learn More about Replaygain' => '리플레이게인에 대해 자세히 알아보기',
...
',
      ...
      'The date when the episode should be published.' => '에피소드가 게시되어야 하는 날짜입니다.',
      ...
      'The time that this song should overlap its surrounding songs when fading. Leave blank to use the system default.' => '이 노래가 페이딩 할 때 주변 곡와 겹치는 시간. 시스템 기본값을 사용하려면 공백으로 두십시오.',
      'The time when the episode should be published (according to the stations timezone).' => '에피소드가 게시되어야 하는 시간입니다(방송국 시간대에 따름).',
      ...
      'This will be the file name for your backup, include the extension for file type you wish to use.' => '이는 백업의 파일 이름이 되며 사용하려는 파일 형식의 확장자를 포함합니다.',
