<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Cached' => 'Em Cache',
      'Calculate and use normalized volume level metadata for each track.' => 'Calcula e usa o nível de volume dos metadados para normalizar cada faixa.',
      'Cancel' => 'Cancelar',
      ...
      'Custom HTML for Public Pages' => 'HTML customizado para as páginas públicas',
...
Para adicionar um novo horário agendado, clique no botão abaixo.',
      ...
      'This will be shown on public player pages if the station is offline. Leave blank to default to a localized version of "%{message}".' => 'Isto será exibido nas páginas públicas do player se a estação estiver offline. Deixe em branco para a versão traduzida de "%{message}".',
