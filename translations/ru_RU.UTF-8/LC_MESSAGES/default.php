<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Set to "Yes" to always use "https://" secure URLs, and to automatically redirect to the secure URL when an insecure URL is visited (HSTS)' => 'Выберите параметр для того, чтобы всегда использовать безопасные URL-адреса "https://" и автоматически перенаправлять на безопасный URL-адрес, когда посещается небезопасный URL-адрес (HSTS).',
