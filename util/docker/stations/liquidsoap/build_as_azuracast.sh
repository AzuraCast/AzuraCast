...
opam pin add --no-action liquidsoap https://github.com/savonet/liquidsoap.git#6e56aed06f116fb7ec92f72326faf7b90554efa2
...
opam install -y ladspa.0.2.2 ffmpeg.1.1.3 ffmpeg-avutil.1.1.3 ffmpeg-avcodec.1.1.3 ffmpeg-avdevice.1.1.3 \
    ...
    samplerate.0.1.6 taglib.0.3.9 mad.0.5.2 faad.0.5.0 fdkaac.0.3.2 lame.0.3.6 vorbis.0.8.0 cry.0.6.6 \
