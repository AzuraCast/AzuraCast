...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap-release-assets/releases/download/rolling-release-v2.4.x/liquidsoap-c61a5cb_2.4.0-debian-bookworm-ocaml4.14.2-1_${ARCHITECTURE}.deb"
