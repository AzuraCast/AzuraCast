...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap/releases/download/rolling-release-v2.4.x/liquidsoap-66ef1d9_2.4.0-debian-bookworm-ocaml4.14.2-1_${ARCHITECTURE}.deb"
