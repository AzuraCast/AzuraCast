...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap-release-assets/releases/download/rolling-release-v2.2.x/liquidsoap-de9dc76_2.2.1-ubuntu-jammy-1_${ARCHITECTURE}.deb"
