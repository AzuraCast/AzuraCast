...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap/releases/download/v2.4.0-rc1/liquidsoap_2.4.0-debian-bookworm-ocaml4.14.2-1_${ARCHITECTURE}.deb"
