...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap-release-assets/releases/download/rolling-release-v2.1.x/liquidsoap-396d927_2.1.0-ubuntu-focal-1_${ARCHITECTURE}.deb"
