...
wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap-release-assets/releases/download/rolling-release-v2.3.x/liquidsoap-b18d14a_2.3.0-debian-bookworm-1_${ARCHITECTURE}.deb"
