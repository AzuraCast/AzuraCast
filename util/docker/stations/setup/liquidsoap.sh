...
# wget -O /tmp/liquidsoap.deb "https://github.com/savonet/liquidsoap-release-assets/releases/download/rolling-release-v2.4.x/liquidsoap-3b02629_2.4.2-debian-trixie-ocaml4.14.2-1_${ARCHITECTURE}.deb"
